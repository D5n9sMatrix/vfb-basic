...
void fb_Sleep( int32 );
static void fb_ctor__boldlist( void ) __attribute__(( constructor ));
void* memmove( void*, void*, uint64 );
int32 strcmp( uint8*, uint8* );
void qsort( void*, uint64, uint64, tmp$3 );
...
int32 QSORTLISTUSAGE( int32*, int32* );
...
int32 QSORTLISTALPHA( int32* PI1$1, int32* PI2$1 )
{
	int32 fb$result$1;
	__builtin_memset( &fb$result$1, 0, 4ll );
	label$50:;
	{
		int32 vr$11 = strcmp( (uint8*)*(uint8**)((uint8*)*(struct $11REPLYSTRUCT**)&TREPLYS$ + ((int64)*PI1$1 << (5ll & 63ll))), (uint8*)*(uint8**)((uint8*)*(struct $11REPLYSTRUCT**)&TREPLYS$ + ((int64)*PI2$1 << (5ll & 63ll))) );
		fb$result$1 = vr$11;
		goto label$51;
	}
	label$51:;
...
int32 QSORTLISTUSAGE( int32* PI1$1, int32* PI2$1 )
{
	int32 fb$result$1;
	__builtin_memset( &fb$result$1, 0, 4ll );
	label$52:;
	{
		fb$result$1 = (int32)((int64)*(int32*)((uint8*)((uint8*)*(struct $11REPLYSTRUCT**)&TREPLYS$ + ((int64)*PI2$1 << (5ll & 63ll))) + 24ll) - (int64)*(int32*)((uint8*)((uint8*)*(struct $11REPLYSTRUCT**)&TREPLYS$ + ((int64)*PI1$1 << (5ll & 63ll))) + 24ll));
		goto label$53;
	}
	label$53:;
	return fb$result$1;
...
__attribute__(( constructor )) static void fb_ctor__boldlist( void )
{
	label$0:;
	...
	label$95:;
	{
		...
		qsort( *(void**)((uint8*)&TREPLYS$ + 72ll), *(uint64*)((uint8*)&TREPLYS$ + 224ll), 4ull, (tmp$3)&QSORTLISTUSAGE );
		{
			int64 IWORDS$2;
			IWORDS$2 = *(int64*)((uint8*)&TREPLYS$ + 224ll) + -1ll;
			{
				...
				label$103:;
				{
					...
					int32 vr$16 = fb_GetX(  );
					if( (int64)vr$16 <= 70ll ) goto label$105;
					{
						goto label$102;
						label$105:;
					}
				...
				N$3 = N$3 + 1ll;
				label$100:;
				if( N$3 <= TMP$49$3 ) goto label$103;
				label$102:;
			}
			fb_PrintVoid( 0, 1 );
			{
				...
				label$109:;
				{
					...
					int32 vr$28 = fb_GetX(  );
					if( (int64)vr$28 <= 70ll ) goto label$111;
					{
						goto label$108;
						label$111:;
					}
				...
				N$3 = N$3 + 1ll;
				label$106:;
				if( N$3 <= TMP$51$3 ) goto label$109;
				label$108:;
			}
			fb_PrintVoid( 0, 1 );
			{
				...
				label$115:;
				{
					...
					FBSTRING* vr$46 = fb_IntToStr( *(int32*)((uint8*)((uint8*)*(struct $11REPLYSTRUCT**)&TREPLYS$ + ((int64)*(int32*)((uint8*)*(int32**)((uint8*)&TREPLYS$ + 72ll) + (N$3 << (2ll & 63ll))) << (5ll & 63ll))) + 24ll) );
					__builtin_memset( &TMP$55$4, 0, 24ll );
					FBSTRING* vr$49 = fb_StrConcat( &TMP$55$4, (void*)"(", 2ll, (void*)vr$46, -1ll );
					__builtin_memset( &TMP$56$4, 0, 24ll );
					FBSTRING* vr$52 = fb_StrConcat( &TMP$56$4, (void*)vr$49, -1ll, (void*)")", 2ll );
					fb_PrintString( 0, (FBSTRING*)vr$52, 0 );
					int32 vr$53 = fb_GetX(  );
					if( (int64)vr$53 <= 70ll ) goto label$117;
					{
						goto label$114;
						label$117:;
					}
				...
				N$3 = N$3 + 1ll;
				label$112:;
				if( N$3 <= TMP$52$3 ) goto label$115;
				label$114:;
			}
			fb_PrintVoid( 0, 1 );
		}
	...
	label$97:;
	FBSTRING* vr$57 = fb_StrLcase2( (FBSTRING*)&ANS$0, 0 );
	int32 vr$58 = fb_StrCompare( (void*)vr$57, -1ll, (void*)"quit", 5ll );
	if( (int64)vr$58 != 0ll ) goto label$95;
	label$96:;
	fb_Sleep( -1 );
